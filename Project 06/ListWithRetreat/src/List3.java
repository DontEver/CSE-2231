...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        // point to first node in right or postFinish if right is empty
        newNode.previous = this.lastLeft; // point back to lastLeft

        // adjust the links of surrounding nodes
        this.lastLeft.next.previous = newNode;
        this.lastLeft.next = newNode;

        // increase rightLength since we add element to right
        this.rightLength++;
    ...
    public final void advance() {
        ...
        this.lastLeft = this.lastLeft.next; // move divider one node to the right
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToFinish() {
        ...
        // set lastLeft to node before postFinish
    ...
    public final void retreat() {
        ...
        // move divider one node to the left
