...
public abstract class StatementTest {
    ...
    /**
     * Test of parse on syntactically invalid input missing keyword.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseWrongWord() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorWrongWordForEnd() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test
    public final void testParseValidinputwithEmptyBlock() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
     ...
     */
    @Test
    public final void testParseValidinputwithEmptyBlock2() {
        /*
         * Setup
         */
        Statement sRef = this.constructorRef();
    ...
    /**
     * Test of parse on syntactically invalid input with wrong keyword.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorwithlackofWord() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorwithoutconditionforIF() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
     ...
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorwithoutconditionforWhile() {
        /*
         * Setup
         */
        Statement sTest = this.constructorTest();
